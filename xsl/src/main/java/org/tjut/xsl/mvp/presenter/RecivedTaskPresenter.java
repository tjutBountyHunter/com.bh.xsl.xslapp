 ...
 */
@FragmentScope
public class RecivedTaskPresenter extends BasePresenter<RecivedTaskContract.Model, RecivedTaskContract.View> {
    @Inject
    ...
    @Inject
    public RecivedTaskPresenter(RecivedTaskContract.Model model, RecivedTaskContract.View rootView) {
